    ...
    private fun FlowContent.pluginExamples() {
        ...
        PrismKotlinScript(
            """
                PrismKotlin(
                    "... code ...", 
                    Prism.Plugin.LineNumbers(start = -5 /** detault 1 */, softWrap = true /** default false */)
                )                
            """.trimIndent()
        )
        ...
        PrismHtml(
            ...
            """.trimIndent(),
            Prism.Plugin.LineNumbers(start = -5, softWrap = true)
        )
    }

    private fun FlowContent.languageExamples() {

        val plugins: Array<Prism.Plugin> = arrayOf(
            Prism.Plugin.InlineColor,
            Prism.Plugin.LineNumbers(),
            Prism.Plugin.ShowLanguage(),
        )
